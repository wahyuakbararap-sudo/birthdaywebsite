...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('May 16, 2026 00:00:00').getTime(),
...
const _slideEnam = function () {
  ...
  // Nah ini tambahan buat nampilin bingkai fotonya
  const bingkaiFoto = document.getElementById('bingkaiFoto');
  if(bingkaiFoto) {
    setTimeout(() => {
      bingkaiFoto.classList.remove('d-none');
    }, 1000); 
  }
};
...
new TypeIt("#teks2", {
  strings: ["Dengan ataupun tanpaku, semoga semesta selalu membahagiakan kamu bagimanapun caranya.", " ", "barakallah fi umrik, terima kasih sudah bertahan sampai sejauh ini.", " ", "- Wish all you the best amanda"],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
